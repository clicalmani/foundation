 ...
 * @method static \Clicalmani\Routing\Factory\RouteResourceInterface match(array $matches, string $uri, mixed $action) Method MATCH
 * @method static \Clicalmani\Routing\Factory\RouteResourceInterface resource(mixed $resource, ?string $controller = null)
 * @method static \Clicalmani\Routing\Factory\RouteResourceInterface apiResource(mixed $resource, ?string $controller = null, ?array $actions = [])
 ...
 * @method static \Clicalmani\Routing\Factory\RouteResourceInterface singleton(string $resource, string $controller) Method GET
